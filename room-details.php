...
<div class="min-h-full">
  ...
  <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Room #67</h1>
    </div>
  </header>
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div class="">
        <div class="flex items-center justify-end">
            <span class="px-3 py-1 text-sm font-bold text-gray-100 transition-colors duration-300 transform bg-gray-600 rounded" tabindex="0" role="button">78.80 &euro;</span>
        </div>

        <div class="mt-2">
            <h2 class="text-3xl font-bold text-gray-700 dark:text-white" tabindex="0" role="link">Accessibility tools for designers and developers</h2>
            <p class="mt-6 text-gray-600 dark:text-gray-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora expedita dicta totam aspernatur doloremque. Excepturi iste iusto eos enim reprehenderit nisi, accusamus delectus nihil quis facere in modi ratione libero!</p>
        </div>
    </div>
        ...
        <div class="container px-6 py-12 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                <div>
                    ...
                    <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Service 1</h1>
                </div>
                ...
                <div>
                    ...
                    <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Service 2</h1>
                </div>
                ...
                <div>
                    ...
                    <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Service 3</h1>
                </div>
                ...
                <div>
                    ...
                    <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Service 4</h1>
                </div>
            </div>
        </div>
    </section>
